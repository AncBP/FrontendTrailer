...
const Cliente = () => {
  ...
  return (
    <div className="p-6 bg-gray-50 min-h-screen">
      <h1 className="text-2xl font-bold text-gray-700 mb-6">Cliente</h1>
        ...
        <div className="fixed inset-0 flex items-center justify-center bg-black/30 z-50">
          <div className="bg-white p-6 rounded-lg shadow-lg w-[700px] max-h-[90vh] ">
            <div className="flex justify-between items-center mb-4">
              <h2 className="text-xl font-semibold">{modo === 'agregar' ? 'Agregar Cliente' : 'Editar Cliente'}</h2>
            ...
            <form>
              ...
              <div className="flex gap-x-4 mb-4">
                <div className="w-1/3">
                  ...
                  <select
                    name="documentType"
                    value={nuevoCliente.document.documentType}
                    onChange={handleChange}
                    required
                ...
                <div className="w-2/3">
                  ...
                  <input
                    ...
                    value={nuevoCliente.document.number}
                    onChange={handleChange}
                    name="number"
                    required
                    type="text"
